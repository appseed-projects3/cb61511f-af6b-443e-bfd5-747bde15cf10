...
- Timestamp: `2022-07-06 11:00`
- Build ID: `cb61511f-af6b-443e-bfd5-747bde15cf10`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/cb61511f-af6b-443e-bfd5-747bde15cf10.git
$ cd cb61511f-af6b-443e-bfd5-747bde15cf10
```
